...
#SBATCH --job-name=aggregate_rdr_hereg
...
echo "--- Starting GCTA HEreg results aggregation ---"
python aggregate_gcta_hereg_results.py
echo "--- HEreg aggregation script finished successfully. ---"