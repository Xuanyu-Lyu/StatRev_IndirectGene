...
import os
import sys
# Add the specific folder containing SimulationFunctions.py
simulation_path = "/Users/xuly4739/Library/CloudStorage/OneDrive-UCB-O365/Documents/coding/PyProject/StatRev_IndirectGene/Scripts/01-Simulation"
...
def main():
    ...
    base_params = {
        ...
        "pop_size": 5000,          # Population size (smaller for testing)
        ...
        "save_each_gen": True,    # Don't save all generations' data
        "save_covs": False,        # Don't save covariances
        "summary_file_scope": "all",  # Only save final summary
        "seed": 12345
    }
    ...
    # am_list: assortative  correlation matrices for each generation
    ...
    # Set up output file
    output_dir = "/Users/xuly4739/Library/CloudStorage/OneDrive-UCB-O365/Documents/coding/PyProject/StatRev_IndirectGene/Scripts/PythonRDR/pySim/output"
    summary_filename = os.path.join(output_dir, "test_simulation_summary.txt")
    base_params["output_summary_filename"] = summary_filename
    base_params["save_each_gen"] = True  # Only save final summary
    ...
    try:
        ...
        if results is not None:
            ...
            save_simulation_results(
                ...
                file_prefix="test_simulation",
                scope=[0,1,2,20]  # Only save the final generation summary
            )
