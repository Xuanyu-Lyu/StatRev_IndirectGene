...
Modifications from Xuanyu: 
1. Change all the python2 xrange to python3 range
"""
import numpy as np
import argparse
...
if args.covariates is None:
    ...
    for i in range(0, covars.shape[0]):
        if covar_id_in_trait[i]:
            for j in range(0, ncovar):
