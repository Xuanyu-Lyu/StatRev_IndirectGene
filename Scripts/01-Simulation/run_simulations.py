...
def main():
    ...
    d_mat_val = np.diag([np.sqrt(0.3), np.sqrt(0.3)]); 
    a_mat_val = np.diag([np.sqrt(0.5), np.sqrt(0.5)]); 
    ...
    am_list_val = [np.array([[0.3, 0.05], [0.05, 0.3]])] * int(base_params["num_generations"])
    ...
    f_mat_uni = np.array([[.3,0],[0,0]]); 
    s_mat_uni = np.array([[0,0],[0,0.5]]); 
    am_list_val_null = [np.array([[0,0], [0, 0]])] * int(base_params["num_generations"]); 
    cove_val_uni = np.array([[0.2,0], [0, 0.2]])
    ...
    #     #{"condition_name": "t1pheVT_t2socVT_uniphenoAM", "simulation_params": {**base_params, "rg_effects": 0, "mating_type": "phenotypic", "f_mat": f_mat_uni, "s_mat": s_mat_uni, "cove_mat": cove_val_uni, "am_list": am_list_val_uni}}
    # ]
    # simulation_conditions = [
    ...
    f_mat_c6 = np.array([[0,0],[0,0.3]]); am_list_val_c6 = [np.array([[0.3,0], [0, 0.3]])] * int(base_params["num_generations"])
    f_mat_c7 = np.array([[0,0],[0,0.3]]); am_list_val_c7 = [np.array([[0.3,0], [0, 0.3]])] * int(base_params["num_generations"])
    f_mat_c8 = np.array([[0,0],[0,0.3]]); am_list_val_c8 = [np.array([[0.3,0], [0, 0.3]])] * int(base_params["num_generations"])
    simulation_conditions = [
