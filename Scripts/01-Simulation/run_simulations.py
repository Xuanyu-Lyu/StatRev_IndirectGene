...
def main():
    ...
    f_mat_uni = np.array([[.3,0],[0,0]]); s_mat_uni = np.array([[0,0],[0,0.5]]); am_list_val_uni = [np.array([[0.3,0], [0, 0.3]])] * int(base_params["num_generations"]); cove_val_uni = np.array([[0.2,0], [0, 0.2]])
